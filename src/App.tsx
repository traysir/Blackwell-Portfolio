        ...
        <div className="max-w-7xl mx-auto px-6 py-6">
          ...
          {mobileMenuOpen && (
            <div className="md:hidden mt-6 pb-6 space-y-4 border-t border-neutral-200 pt-6">
              <a href="#work" className="block text-sm hover:text-emerald-600 transition-colors">/work</a>
              <a href="#projects" className="block text-sm hover:text-emerald-600 transition-colors">/projects</a>
              <a href="#skills" className="block text-sm hover:text-emerald-600 transition-colors">/skills</a>
              <a href="#contact" className="block text-sm hover:text-emerald-600 transition-colors">/contact</a>
            </div>
          )}
        </div>
      </nav>
