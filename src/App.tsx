                      ...
                      <div className="flex items-center gap-4 mb-2">
                        {job.logo ? (
                          <img 
                            src={job.logo} 
                            alt={job.company}
                            className={`h-10 w-10 object-contain grayscale ${job.company === 'Amazon' ? 'group-hover:grayscale-0' : 'group-hover:grayscale-0 group-hover:invert'} transition-all duration-300`}
                          />
                        ) : (
